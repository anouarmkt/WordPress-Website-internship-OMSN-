<?php
/**
 * The Conference Customizer Slider Control.
 * 
...
if ( ! class_exists( 'The_Conference_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class The_Conference_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'the-conference-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'the-conference-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
