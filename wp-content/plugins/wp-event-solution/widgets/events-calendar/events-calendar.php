...
class Etn_Events_Calendar extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Eventin Events Calendar', 'eventin' );
    }
    ...
    protected function render() {
        ...
        include \Wpeventin::plugin_dir() . "widgets/events-calendar/style/{$style}.php";
    }
