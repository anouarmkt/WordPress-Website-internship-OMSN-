...
$generated_i18n_strings = array(
	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:129
	...
	__( 'See Your Conversion Rate to Improve Your Funnel', 'google-analytics-for-wordpress' ),
	...
	__( 'See Your Traffic Demographics', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/settings/monsterinsights-site.vue:85
	__( 'Congratulations! ', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/monsterinsights-site.vue:86
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:137
	__( 'Read the Full Guide', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:138
	__( 'MonsterInsights Features & Addons', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:139
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:153
	__( 'Google Analytics Dashboard', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:154
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:158
	__( 'Real-time Stats', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:159
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:163
	__( 'Enhanced Ecommerce Tracking', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:164
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:168
	__( 'Page Level Analytics', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:169
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:173
	__( 'Affiliate Link & Ads Tracking', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:174
	...
	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:178
	__( 'EU Compliance (GDPR Friendly)', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/monsterinsights-welcome-Lite.vue:179
	...
	// Reference: src/modules/settings/components/SettingsFirstTImeNotice.vue:46
	...
	// Reference: src/modules/settings/components/SettingsFirstTImeNotice.vue:47
	...
	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:115
	__( 'Inbox', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:116
	__( 'Back to Inbox', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:117
	__( 'View Dismissed', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:118
	__( 'Notifications', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:119
	__( 'Dismiss All', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:120
	__( 'Dismissed', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/monsterinsights-Notifications.vue:121
	...
	// Reference: src/modules/settings/routes/site.js:104
	...
	__( 'New Customers', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/widget/store/index.js:120
	__( 'This list shows the percentage of new customers who purchased a product from your website.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/widget/store/index.js:127
	__( 'Abandoned Checkouts', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:108
	__( 'GDPR Guide', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:109
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:114
	__( 'How to Install and Activate MonsterInsights Addons', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:115
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:120
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:125
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:70
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:72
	__( 'Launch the wizard!', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:78
	__( 'See your website analytics reports inside the WordPress dashboard', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:79
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:85
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:87
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:96
	__( 'How to Connect to Google Analytics', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:97
	...
	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:102
	__( 'Guide and Checklist for Advanced Insights', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/about/components/monsterinsights-AboutTabGettingStarted.vue:103
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:116
	__( 'Make your MonsterInsights campaign links prettier with Pretty Links!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:117
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:118
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:119
	__( 'Over 200,000 websites use Pretty Links!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:120
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:124
	__( 'Activate Pretty Links', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:125
	__( 'Activating Pretty Links...', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:126
	__( 'Create New Pretty Link', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:127
	__( 'Create a New Pretty Link', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsPrettyLinksFlow.vue:128
	__( 'Grab your campaign link and paste it into the Target URL field.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:176
	__( 'Custom Campaign Parameters', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:177
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:184
	/* Translators: Marks the field as required. */
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:196
	__( 'Enter something to differentiate ads', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:197
	__( 'Use Fragment', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:199
	/* Translators: Make the text bold. */
	__( 'Set the parameters in the fragment portion of the URL %1$s(not recommended)%2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:200
	__( 'URL to use', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:201
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:216
	__( 'Campaign Source', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:217
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:219
	__( 'Use utm_medium to identify a medium such as email or cost-per-click.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:220
	__( 'Campaign Name', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:221
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:223
	__( 'Used for paid search. Use utm_term to note the keywords for this ad.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:224
	__( 'Campaign Content', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:225
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:227
	/* Translators: Example. */
	__( 'Example: %s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:229
	/* Translators: Examples. */
	__( 'Examples: %s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:232
	__( 'About Campaigns', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:236
	__( 'About Custom Campaigns', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:240
	__( 'Best Practices for Creating Custom Campaigns', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:244
	__( 'About the Referral Traffic Report', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:248
	__( 'About Traffic Source Dimensions', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:252
	__( 'AdWords Auto-Tagging', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabUrlBuilder.vue:256
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabImportExport.vue:52
	__( 'Click Choose file below to select the settings export file from another site.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabImportExport.vue:53
	__( 'Use the button below to export a file with your MonsterInsights settings.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabImportExport.vue:66
	__( 'Uploading file...', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabImportExport.vue:81
	__( 'File imported', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/monsterinsights-ToolsTabImportExport.vue:82
	...
	// Reference: src/modules/tools/components/monsterinsights-ToolsTabImportExport.vue:89
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWpforms.vue:47
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWpforms.vue:48
	__( 'Used on over 4,000,000 websites!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWpforms.vue:49
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWpforms.vue:50
	...
	// Reference: src/modules/reports/store/actions.js:75
	...
	// Reference: src/modules/frontend/components/monsterinsights-FrontendStatsGeneral.vue:54
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEcommerce-Lite.vue:57
	__( 'Enable Ecommerce Tracking and Grow Your Business with Confidence', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEcommerce-Lite.vue:58
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEcommerce-Lite.vue:61
	__( 'Affiliate Tracking', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEcommerce-Lite.vue:62
	...
	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:124
	...
	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:131
	__( 'Cart Funnel', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:136
	__( 'Customer Insights', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:141
	__( 'Campaign Measurement', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:146
	__( 'Customer Profiles', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:157
	...
	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:110
	__( 'Truly Understand Your%1$s Customers With %2$sMonsterInsights%3$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:111
	...
	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:113
	...
	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:114
	__( 'FEATURES', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:115
	__( 'Get The Unique Metrics Neccessary for Growth', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:116
	...
	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:119
	__( 'Did the login/registration step of the checkout put users off?', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:120
	__( 'Which ad campaign is driving the most revenue?', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:121
	__( 'Who is my typical customer?', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/woocommerce-insights/woocommerce-insights-Lite.vue:123
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:133
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:134
	__( 'Finish Setup & Exit Wizard', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:181
	__( 'Checking your website...', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/widget/components/WidgetReportsLink.vue:20
	...
	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:350
	__( 'So, where did all of these visitors come from?', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:351
	__( 'Clicks', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:352
	__( 'Your Top 5 Keywords', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:353
	__( 'What keywords visitors searched for to find your site', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:354
	__( 'Your Top 5 Referrals', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:356
	__( 'The websites that link back to your website', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:357
	__( 'Opportunity', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:358
	...
	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:359
	__( 'Read - How to Ethically Steal Your Competitor’s Traffic', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:361
	__( 'Thank you for using MonsterInsights!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Lite.vue:362
	...
	// Reference: src/modules/widget/components/settings/WidgetSettingsReports-Lite.vue:75
	__( 'Available in PRO version', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/SettingsLiteUpsellLarge.vue:23
	...
	// Reference: src/modules/addons/components/monsterinsights-AddonBlock.vue:67
	/* Translators: The status of the addon (installed/active/inactive). */
	__( 'Status: %s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/components/monsterinsights-AddonBlock.vue:113
	__( 'Not Installed', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/components/monsterinsights-AddonBlock.vue:119
	__( 'Network Active', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/components/monsterinsights-AddonBlock.vue:119
	__( 'Active', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/components/monsterinsights-AddonBlock.vue:121
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:74
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:78
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:84
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:86
	__( 'Hide Admin Bar Reports', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:91
	/* Translators: placeholders make text small. */
	__( 'Enabled %1$s- Show reports and dashboard widget.%2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:96
	/* Translators: placeholders make text small. */
	__( 'Dashboard Widget Only %1$s- Disable reports, but show dashboard widget.%2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabAdvanced.vue:101
	/* Translators: placeholders make text small. */
	__( 'Disabled %1$s- Hide reports and dashboard widget.%2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/notifications/components/NotificationsIndicator.vue:24
	...
	// Reference: src/modules/auth/api/index.js:246
	...
	// Reference: src/components/TheAppFTPForm.vue:119
	__( 'Proceed', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:111
	__( 'Connection Information', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:112
	...
	// Reference: src/components/TheAppFTPForm.vue:113
	__( 'Hostname', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:114
	__( 'FTP Username', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:115
	__( 'FTP Password', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:116
	__( 'This password will not be stored on the server.', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:117
	__( 'Connection Type', 'google-analytics-for-wordpress' ),

	// Reference: src/components/TheAppFTPForm.vue:118
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabPublisher.vue:73
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabPublisher.vue:74
	...
	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:294
	__( 'Your site is connected to MonsterInsights!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:312
	...
	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:133
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:78
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:80
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:82
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:85
	__( 'File Downloads', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:86
	__( 'Extensions of Files to Track as Downloads', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:87
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:91
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:93
	/* Translators: Adds a link to the documentation. */
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:94
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:100
	/* Translators: Adds a link to the documentation. */
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:101
	__( 'Add domain', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:106
	/* Translators: Example domain. */
	__( 'Domain (example: %s)', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:109
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:113
	__( 'Cross Domain Tracking', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEngagement.vue:115
	/* Translators: Adds a link to the documentation. */
	...
	// Reference: src/modules/settings/components/input/tab-general/SettingsInputLicense-Lite.vue:38
	/* Translators: Make text green. */
	...
	__( 'AIOSEO is the DIY Solution for Managing your SEO', 'google-analytics-for-wordpress' ),
	...
	__( 'Optimize Your Pages For Higher Rankings With TruSEO Score.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/yoast.vue:177
	__( 'TruSEO Score gives you a more in-depth analysis into your optimization efforts than just a pass or fail. Our actionable checklist helps you to unlock maximum traffic with each page.', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/settings/components/input/SettingsInputRepeater.vue:198
	__( 'Duplicate values are not allowed.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/SettingsInputRepeater.vue:60
	...
	// Reference: src/modules/settings/components/input/SettingsInputRepeater.vue:69
	...
	// Reference: src/modules/reports/components/reports/monsterinsights-ReportOverview.vue:174
	...
	// Reference: src/modules/reports/components/reports/monsterinsights-ReportOverview.vue:289
	__( 'This list shows the top countries your website visitors are from.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports/monsterinsights-ReportOverview.vue:290
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:95
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:114
	__( 'Helps you increase affiliate revenue.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:115
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:116
	__( 'Affiliate Link Tracking', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:117
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:122
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepAuthenticate.vue:152
	...
	__( 'Improve Your Website Search Rankings With All-In-One SEO', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:164
	__( 'If you’re not using a plugin to optimize your website’s SEO you’re missing out on valuable organic traffic!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:169
	__( 'Finally, a WordPress SEO Plugin that’s Easy and Powerful!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:170
	__( 'AIOSEO makes it easy to set up the proper SEO foundations in less than 10 minutes.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:171
	__( 'Local SEO', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:172
	__( 'All in One SEO gives you all the tools you need to improve your local SEO and rank higher on Google Maps.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:173
	__( 'WooCommerce SEO', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:174
	__( 'Advanced eCommerce SEO support for WooCommerce to optimize product pages, product categories, and more.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:177
	__( 'SEO Custom User Roles', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:178
	__( 'SEO user roles allow you to manage access to important SEO features without handing over control of your website.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:179
	__( 'Google News Sitemap', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:180
	__( 'Get higher rankings and unlock more traffic by submitting your latest news articles to Google News.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:181
	__( 'Smart XML Sitemaps', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:182
	__( 'Automatically generate a WordPress XML sitemap and notify all search engines of any updates.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:183
	__( 'Social Media Integration', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:184
	__( 'Easily control how your content and thumbnails look on Facebook, Twitter, and other social media networks.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:185
	__( 'TruSEO On-Page Analysis', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:186
	__( 'Easily add title tags, meta descriptions, keywords, and everything else you need for proper on-page SEO optimization.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:187
	__( '& Many More!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:241
	__( 'Installing. Please wait..', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/aioseo.vue:267
	__( 'Install All-in-One-SEO', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWelcome.vue:39
	__( 'Welcome to MonsterInsights!', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWelcome.vue:43
	__( 'We will recommend the optimal settings for MonsterInsights based on your choice.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWelcome.vue:47
	__( 'Business Website', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepWelcome.vue:52
	/* Translators: Make text bold. */
	...
	// Reference: src/modules/popular-posts/components/PopularPostsSettings.vue:55
	__( 'Empty Cache', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsSettings.vue:57
	__( 'Click to manually wipe the cache right now.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsSettings.vue:91
	...
	// Reference: src/modules/popular-posts/components/PopularPostsWidget.vue:119
	...
	// Reference: src/modules/popular-posts/components/PopularPostsInline.vue:125
	__( 'Placement', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsInline.vue:126
	__( 'Choose how you\'d like to place the widget.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsInline.vue:127
	...
	// Reference: src/modules/popular-posts/components/PopularPostsInline.vue:138
	__( 'Please select at least one post to display.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsInline.vue:172
	/* Translators: placeholders make text small. */
	__( 'Automatic %1$s- The widget is automatically placed inside the post body.%2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsInline.vue:177
	/* Translators: placeholders make text small. */
	...
	// Reference: src/modules/seo/components/common/testimonials.vue:51
	...
	// Reference: src/modules/seo/components/common/testimonials.vue:52
	__( 'Jack Brown', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/common/testimonials.vue:53
	__( 'PJB Internet Marketing', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/common/testimonials.vue:54
	__( 'I’m a professional SEO and used many tools and extensions. Regarding simplicity, individuality and configurability All in One SEO Pro is by far the best SEO plugin out there for WordPress.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/common/testimonials.vue:55
	__( 'Joel Steinmann', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/seo/components/common/testimonials.vue:56
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:50
 ...
 and other privacy regulations.', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/settings/components/input/tab-engagement/SettingsInputEUCompliance-Lite.vue:24
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsThemePicker.vue:79
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:189
	__( 'Adjust the number of columns displayed when the widget is placed in a wide container.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:190
	__( 'Display Options', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:191
	__( 'Choose which content you would like displayed in the widget.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:192
	__( 'Display Author', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:193
	__( 'Display Date', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:194
	__( 'Display Comments', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:195
	__( 'Comments', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:196
	__( 'Post Count', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetThemeCustomize.vue:197
	__( 'Choose how many posts you’d like displayed in the widget.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsGaInput-Pro.vue:114
	__( 'Popular Posts data can be fetched correctly', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsGaInput-Pro.vue:115
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsGaInput-Pro.vue:59
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsGaInput-Pro.vue:64
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsGaInput-Pro.vue:102
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsSharedCount.vue:35
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsSharedCount.vue:36
	__( 'Start Indexing', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsSharedCount.vue:40
	...
	// Reference: src/modules/settings/components/input/SettingsInputNumber.vue:67
	/* Translators: The minimum set value. */
	__( 'Please enter a value higher than %s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/SettingsInputNumber.vue:69
	/* Translators: The maximum set value. */
	__( 'Please enter a value lower than %s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/SettingsInputNumber.vue:70
	__( 'Please enter a number', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/SettingsInputNumber.vue:71
	__( 'Value has to be a round number', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/monsterinsights-ReportsPdfExport-Lite.vue:44
	__( 'Export PDF Report', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/monsterinsights-ReportsPdfExport-Lite.vue:52
	...
	// Reference: src/modules/reports/components/reports-overview/ReportOverviewUpsellMobile-Lite.vue:23
	/* Translators: Make text green. */
	__( 'Upgrade to Pro and unlock addons and other great features. %1$sSave 50%% automatically!%2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/reports-overview/monsterinsights-ReportOverviewDatePicker-Lite.vue:52
	...
	// Reference: src/modules/wizard-onboarding/components/inputs/OnboardingImprove-Lite.vue:22
	/* Translators: Adds a link to the documentation. */
	...
	// Reference: src/modules/wizard-onboarding/components/inputs/OnboardingAuthenticate-Lite.vue:81
	__( 'Website profile', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/inputs/OnboardingAuthenticate-Lite.vue:82
	__( 'Active profile', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/popular-posts/components/PopularPostsProductsUpsell.vue:24
	__( 'This feature requires MonsterInsights Pro', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsProductsUpsell.vue:25
	...
	// Reference: src/modules/popular-posts/components/PopularPostsProductsUpsell.vue:26
	__( 'Upgrade to Pro and Unlock Popular Products', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/PopularPostsProductsUpsell.vue:27
	__( 'View all Pro features', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsCacheInterval-Lite.vue:15
	__( 'Days', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsCacheInterval-Lite.vue:20
	/* Translators: placeholders make text small. */
	__( '7 days', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsCacheInterval-Lite.vue:24
	__( '30 days', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsCacheInterval-Lite.vue:29
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsMultipleEntries-Lite.vue:28
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsGaInput-Lite.vue:35
	/* Translators: Placeholder adds a link to the Custom Dimensions settings. */
	...
	// Reference: src/modules/popular-posts/components/PopularPostsUpgradeOverlay.vue:29
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:132
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:133
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:134
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:143
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:144
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:150
	__( 'Enable Automatic Placement', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:151
	__( 'Display in a Sidebar', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:152
	...
	// Reference: src/modules/popular-posts/components/input/PopularPostsWidgetPlacement.vue:153
	...
	// Reference: src/modules/growth-tools/components/GrowthNavigation.vue:18
	__( 'Traffic', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/components/GrowthNavigation.vue:20
	...
	// Reference: src/modules/reports/components/upsells/ReportUpsellOverlay.vue:36
	__( 'Upgrade and Unlock', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/upsells/ReportUpsellOverlay.vue:48
	...
	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:106
	__( 'Launch giveaways and raffle campaigns to grow your email lists, increase traffic, and get more social media followers.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:116
	__( 'Constant Contact', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:117
	__( 'Create amazing email marketing campaigns with drag and drop simplicity. Exclusive Offer: Save 20%.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:127
	__( 'SEMRUSH', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:128
	__( 'Perform SEO and content marketing research, track keywords, and much more. Special Offer: First 30 Days Free.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:141
	__( 'Engagement Tools', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:145
	__( 'WPForms', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:158
	__( 'Convert and monetize more of your website traffic with engaging pop-up and gamified tools. Great for all types of websites.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:168
	__( 'Smash Balloon - Facebook', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:179
	__( 'Smash Balloon - Instagram', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:180
	__( 'Quickly add social media feeds from Facebook, Instagram, Twitter, and others to your website, with no coding needed.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:190
	__( 'Popular Posts by MonsterInsights', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:191
	__( 'Increase your visitor engagement by automatically embedding popular and related content from your website.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:202
	__( 'Popular Products by MonsterInsights', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:203
	__( 'Automatically show related products to increase conversion rates and increase cart sizes on your eCommerce website.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:217
	__( 'Revenue Tools', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:232
	__( 'SeedProd', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:233
	__( 'Use the best drag-and-drop landing page builder for WordPress to instantly build coming soon pages, sales pages, opt-in pages, webinar pages, maintenance pages, and more. Includes 100+ free templates.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:23
	__( 'Featured Tools', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:243
	__( 'Easy Affiliate', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:244
	__( 'Launch, grow, and manage an affiliate program, all right from your WordPress dashboard. Works automatically with MonsterInsights.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:254
	__( 'SearchWP', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:255
	__( 'Unlock better search results for your website.  Perfect for any information or eCommerce store to help users find exactly what content and products they’re looking for.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:266
	__( 'Easily sell digital products like ebooks, plugins, and courses with WordPress. Built-in payment processing, coupons, shopping cart, detailed reporting, and more.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:277
	__( 'Create a membership website. Works automatically with MonsterInsights, no coding needed.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:287
	__( 'Thirsty Affiliates', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:288
	__( 'Manage all your affiliate links with features designed to help make bloggers more money.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:28
	__( 'Upgrade to unlock advanced reporting and features designed to help you get more traffic and make more money from your website.  Special Offer: Save 50% today.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:298
	__( 'Advanced Coupons', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:299
	__( 'Create coupons, reward loyal customers, and schedule promotions for your eCommerce store.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:309
	__( 'PrettyLinks', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:310
	...
	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:313
	__( 'Install Now', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:323
	__( 'Online Marketing Guides & Resources', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:39
	__( 'MonsterInsights Pro', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:40
	__( 'Upgrade to unlock eCommerce tracking, Custom Dimensions, Form Tracking, and much more. Special Offer: Save 50% today.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:66
	__( 'Traffic Tools', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:82
	__( 'All in One SEO (AIOSEO)', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:83
	__( 'The best WordPress SEO plugin that works automatically with MonsterInsights.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:94
	__( 'PushEngage', 'google-analytics-for-wordpress' ),
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEcommerce-Lite.vue:63
	...
	// Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabEcommerce-Lite.vue:64
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:129
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:137
	__( 'Success', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:138
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:147
	/* Translators: Add link to retrieve license from account area. */
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:153
	__( 'Verify License Key', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:155
	__( 'Upgrade to Unlock These Features', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:156
	__( 'To unlock the selected features, please upgrade to Pro and enter your license key below.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:157
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepSuccess.vue:209
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:186
	__( 'Advanced Growth Tools', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:187
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:198
	__( 'Track how your users interact with videos on your website.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:343
	__( 'Error Processing', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:344
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:51
	__( 'Continue', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:82
	__( 'Standard Analytics & Reports', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:83
	__( 'Get the reports and stats that matter right inside your WordPress Dashboard.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:95
	__( 'Helps you see what links your users are clicking on your site.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:106
	__( 'All In One SEO Toolkit', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:107
	__( 'The best WordPress SEO plugin that works with MonsterInsights to boost your rankings.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:130
	...
	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:53
	...
	__( 'Warning: If you use a manual GA4 Measurement ID, you won\'t be able to use any of the reporting and some of the tracking features. Your Measurement ID should look like G-XXXXXXXXXX where the X\'s are a combination of numbers and letters.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:154
	__( 'Your Measurement ID should look like G-XXXXXXXXXX where the X\'s are a combination of numbers and letters.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/components/ReportNoAuth.vue:28
	__( 'MonsterInsights makes it effortless for you to connect your site with Google Analytics and see reports right here in the WordPress dashboard.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/monsterinsights-SettingsNetwork.vue:67
	__( 'Expired', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:221
	__( 'WP Simple Pay', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/growth-tools/monsterinsights-growth-tools.vue:222
	__( 'Start accepting one-time and recurring payments on your WordPress site without setting up a shopping cart. No code required.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/components/monsterinsights-AddonBlock.vue:73
	__( 'License Expired', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/widget/components/WidgetReminder.vue:85
	__( 'Your MonsterInsights license key has expired.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/widget/components/WidgetReminder.vue:86
	__( 'Renew today to ensure Google Analytics continues to track properly.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/widget/components/WidgetReminder.vue:88
	__( 'Click here.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/store/actions.js:65
	/* Translators: Adds a link to the license renewal. */
	__( 'To ensure tracking works properly, reactivate your license', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/store/actions.js:68
	__( 'Reactivate License', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/frontend/components/FrontendUpsell-Lite.vue:13
	__( 'View All Reports', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:100
	__( 'Oops! There was an error processing request. Please try again later.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:82
	/* Translators: tag to make text italic starts, tag end. */
	__( 'See What Your Website Visitors Are %1$sReally%2$s Thinking!', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:83
	__( 'UserFeedback lets you easily collect feedback from your website in real time. You can use this important data to increase your traffic, sales, newsletter signups, engagement, and more.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:86
	__( 'Understand exactly why visitors left your website, what convinced them to make a purchase, why they signed up for a newsletter, and more with real verbatim feedback', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:87
	__( 'Ask open ended questions, run polls or surveys, gather ratings, and more with an easy survey builder', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:88
	__( 'Customize targeting rules to get specific feedback on certain pages or products', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:89
	__( 'Easily analyze your responses and export data', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:91
	__( 'Install & Activate UserFeedback', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:92
	__( 'Install UserFeedback by clicking the button below.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:93
	__( 'Install UserFeedback', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:94
	__( 'Set Up UserFeedback', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:95
	__( 'Run the UserFeedback setup wizard to launch your first UserFeedback survey.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:96
	__( 'Start Setup', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:97
	__( 'Installing UserFeedback', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:98
	__( 'Activating UserFeedback', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/userfeedback/exactmetrics-userfeedback.vue:99
	...
	__( 'Can\'t load settings. Error: %1$s, %2$s. Please %3$scontact our support%4$s team for assistance. ', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:125
	/* Translators: Error status, error text, Support page link tag starts and support page link tag ends. */
	__( 'Oops! We can\'t verify deauthentication. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:18
	/* Translators: Error status, error text, Support page link tag starts and support page link tag ends. */
	__( 'Can\'t load authentication details. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team. ', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:23
	/* Translators: Support page link tag starts and support page link tag ends. */
	__( 'Oops! There was an error loading your site details. Please refresh the page and try again. If the issue persists, please contact our support team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:242
	/* Translators: Error status, error text, Support page link tag starts and support page link tag ends. */
	__( 'Can\'t save settings. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:45
	/* Translators: Error status, error text, Support page link tag starts and support page link tag ends. */
	__( 'Oops! We can\'t authenticate. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team. ', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:71
	/* Translators: Error status, error text, Support page link tag starts and support page link tag ends. */
	__( 'Oops! We can\'t reauthenticate. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/auth/api/index.js:95
	/* Translators: Error status, error text, Support page link tag starts and support page link tag ends. */
	__( 'Oops! We can\'t verify credentials. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/api/index.js:100
	/* Translators: Error status and error text. */
	__( 'Oops! Can\'t install WPForms. Error: %1$s, %2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/api/index.js:134
	/* Translators: Error status and error text. */
	__( 'Oops! Can\'t activate addon. Error: %1$s, %2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/api/index.js:138
	__( 'Oops! There was an error activating the addon. Please try again. If the issue persists, please %1$scontact our support%2$s team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/api/index.js:167
	/* Translators: Error status and error text. */
	__( 'Oops! Can\'t deactivate addon. Error: %1$s, %2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/api/index.js:202
	/* Translators: Error status and error text. */
	__( 'Oops! Can\'t install plugin. Error: %1$s, %2$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/addons/api/index.js:65
	/* Translators: Error status and error text. */
	__( 'Oops! Can\'t install addon. Error: %1$s, %2$s', 'google-analytics-for-wordpress' ),
	...
	__( 'Oops! There was an issue deactivating your license, please try again. If the issue persists, please %1$scontact our support team%2$s. Error: %3$s, %4$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:129
	/* Translators: Support Link tag starts with URL, Support link tag ends. */
	__( 'Oops! There was an issue deactivating your license, please try again. If the issue persists, please %1$scontact our support team%2$s.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:180
	/* Translators: Support Link tag starts with URL, Support link tag ends, Error status and error text. */
	__( 'Oops! There was an issue verifying your license upgrade, please try again. If the issue persists, please %1$scontact our support team%2$s. Error: %3$s, %4$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:185
	/* Translators: Support Link tag starts with URL, Support link tag ends. */
	__( 'Oops! There was an issue verifying your license upgrade, please try again. If the issue persists, please %1$scontact our support team%2$s.', 'google-analytics-for-wordpress' ),
	...
	__( 'Oops! There was an issue loading your license details, please try again. If the issue persists please %1$scontact our support team%2$s. Error: %3$s, %4$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:25
	__( 'Oops! There was an issue loading your license details, please try again. If the issue persists, please %1$scontact our support team%2$s.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:59
	/* Translators: Support Link tag start with URL, Support link tag ends, Error status and error text. */
	__( 'Oops! There was an issue verifying your license, please try again. If the issue persists, please %1$scontact our support team%2$s. Error: %3$s, %4$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:64
	/* Translators: Support Link tag starts with URL, Support link tag ends. */
	__( 'Oops! There was an issue verifying your license, please try again. If the issue persists, please %1$scontact our support team%2$s.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:86
	/* Translators: Support Link tag start with URL, Support link tag ends, Error status and error text. */
	__( 'Oops! There was an issue validating your license, please try again. If the issue persists, please %1$scontact our support team%2$s. Error: %3$s, %4$s', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/license/api/index.js:91
	/* Translators: Support Link tag starts with URL, Support link tag ends. */
	__( 'Oops! There was an issue validating your license, please try again. If the issue persists, please %1$scontact our support team%2$s.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/reports/api/index.js:22
	/* Translators: Error status, error text, Support link tag starts with url and support link tag ends. */
	__( 'Can\'t load report data. Error: %1$s, %2$s. Please try again in a few minutes. If the issue persists, please %3$scontact our support%4$s team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/popular-posts/components/input/PopularPostsPostsPicker.vue:94
	/* Translators: Support link tag starts with url and support link tag ends. */
	__( 'Oops! Can\'t load posts. Please try again in a few minutes. If the issue persists, please %1$scontact our support%2$s team.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/routes/site.js:120
	__( 'Website Badge', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:49
	__( 'Automatic Display', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:50
	__( 'Automatically Display Website Badge in Website Footer', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:51
	__( 'Enabling will add the chosen badge in your website’s footer.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:52
	__( 'Enable Automatic Display', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:53
	__( 'Appearance', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:54
	__( 'Choose your badge style.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:55
	__( 'Position', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:56
	__( 'Select the position of the badge in your website’s footer.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:59
	__( 'Manual Display', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:60
	__( 'Copy', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:65
	__( 'Light', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:69
	__( 'Dark', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:75
	__( 'Left', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:79
	__( 'Center', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/tools/components/ToolsTabVerifiedBadge.vue:83
	...
	__( 'Show MonsterInsights Badge', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepRecommendedSettings.vue:94
	__( 'Build trust with website visitors by automatically placing a MonsterInsights badge in your website’s footer.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/OnboardingStepAuthenticate.vue:87
	__( 'Warning: If you use a manual UA code, you won\'t be able to use any of the reporting and some of the tracking features. Your UA code should look like UA-XXXXXX-XX or GT-XXXXX where the X\'s are numbers.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:118
	__( 'Conversion Tools', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/wizard-onboarding/components/steps/monsterinsights-OnboardingStepRecommendedAddons-Lite.vue:119
	__( 'Get the #1 conversion optimization plugin to convert your growing website traffic into subscribers, leads and sales.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:138
	__( 'Warning: If you use a manual UA code, you won\'t be able to use any of the reporting and some of the tracking features. Your UA code should look like UA-XXXXXX-XX where the X\'s are numbers or GT-YYYYY where the Y\'s are combination of numbers and letters.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:140
	__( 'Warning: If you use a manual GA4 Measurement ID, you won\'t be able to use any of the reporting and some of the tracking features. Your Measurement ID should look like G-XXXXXXXXXX or GT-XXXXX where the X\'s are combination of numbers and letters.', 'google-analytics-for-wordpress' ),

	// Reference: src/modules/settings/components/input/tab-general/monsterinsights-SettingsInputAuthenticate-Lite.vue:148
